...
Use [JVM Toolchains](https://docs.gradle.org/8.11/userguide/toolchains.html), or the link:{javadocPath}/org/gradle/api.tasks/compile/ForkOptions.html#getExecutable()}[Executable] property instead.
